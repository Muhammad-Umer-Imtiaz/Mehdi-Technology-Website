  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 md:text-center  xl:max-w-5xl 2xl:max-w-7xl md:mt-28 px-5   mx-auto">
        ...
        <Link
          href="/#service"
          className="inline-flex mx-auto items-center bg-white md:px-8 px-4 py-2 md:mt-10 mt-6 rounded-md font-semibold text-2xl text-[#007BFF] shadow-[0_0_7px_0_rgba(255,255,255,0.8)] hover:opacity-90 transition-all duration-300"
        >
