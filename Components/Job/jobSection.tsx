  ...
  return (
    <section className="2xl:max-w-7xl xl:max-w-5xl w-full mx-auto py-20 px-5">
      <div className="md:text-center mb-16">
        <span className="text-[#007BFF] bg-white inline-block border-2 border-gray-500 px-6 py-1.5 text-xl font-medium rounded-full tracking-[0.3em] mb-4">
          CURRENT OPENINGS
        </span>
        ...
        <p className="text-gray-600 text-base md:text-lg mx-auto">
          Innovate, build, and grow with a company that ships real impact.
        </p>
      </div>
